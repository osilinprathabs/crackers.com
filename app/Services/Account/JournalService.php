...
use App\Events\Account\UpdateBudgetSpending;
...
class JournalService
{
    ...
    {
        $retainerAllocationClass = 'Workdo\\Retainer\\Models\\RetainerPaymentAllocation';
        if (! class_exists($retainerAllocationClass)) {
            return null;
        }

        $allocations = $retainerAllocationClass::whereHas('payment', function($q) {
