...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  // EMI Collection statistics Chart
  // --------------------------------------------------------------------
      ...
      series: [
        {
          name: 'Collected EMI',
          type: 'column',
          data: [380000, 450000, 330000, 380000, 320000, 500000, 480000, 400000, 420000, 370000]
        },
        {
          name: 'Pending EMI',
          type: 'line',
          data: [230000, 280000, 230000, 320000, 280000, 440000, 320000, 380000, 260000, 340000]
        }
      ],
      chart: {
        height: 280,
  ...
  // Loan Distribution by Type Chart
  // --------------------------------------------------------------------
  const deliveryExceptionsChartE1 = document.querySelector('#deliveryExceptionsChart'),
    deliveryExceptionsChartConfig = {
      ...
      labels: ['Personal Loan', 'Vehicle Loan', 'Home Loan', 'Business Loan', 'Educational Loan'],
      series: [85, 62, 135, 98, 45],
      colors: [
