...
@section('content')
  ...
  <div class="misc-wrapper">
    ...
    <div class="d-flex justify-content-center mt-12">
      ...
      <img src="{{ asset('assets/img/illustrations/misc-bg-' . $configData['theme'] . '.png') }}" alt="misc-server-error"
      ...
      <div class="d-flex flex-column align-items-center">
        <img src="{{ asset('assets/img/illustrations/misc-server-error-illustration.png') }}" alt="misc-server-error"
          class="img-fluid z-1" width="230" />
        <div>
