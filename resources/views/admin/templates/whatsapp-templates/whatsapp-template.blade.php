          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center gap-1">
                <a href="{{ route('whatsapp-template-edit', $template->id) }}" class="btn btn-sm btn-icon btn-text-secondary rounded-pill" title="Edit">
                  <i class="icon-base ri ri-edit-box-line icon-22px text-primary"></i>
                </a>
                <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-text-danger rounded-pill delete-template" 
                  data-id="{{ $template->id }}"
