          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center gap-1">
                <a href="{{ route('email-template-edit', ['id' => $template->id]) }}" class="btn btn-sm btn-icon btn-text-secondary rounded-pill" title="Edit"><i class="icon-base ri ri-edit-box-line icon-22px text-primary"></i></a>
