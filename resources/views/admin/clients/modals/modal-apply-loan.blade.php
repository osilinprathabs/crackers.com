...
<div class="modal fade" id="modalApplyLoan" tabindex="-1" aria-hidden="true">
          ...
          <form id="formApplyLoan" class="row g-5">
            ...
            <div class="col-12" id="loan_mode_container">
              <div class="d-flex align-items-center justify-content-between p-3 border rounded-3 bg-light">
                <div>
                  <h6 class="mb-1 fw-bold">Loan Calculation Mode</h6>
                  <p class="text-muted small mb-0" id="mode_description">Standard EMI (Principal + Interest)</p>
                </div>
                <div class="d-flex align-items-center">
                  <span class="fw-bold small text-primary me-2" id="emi_label_text">EMI Mode</span>
            ...
            <div class="col-12">
              <label class="form-label" for="repayment_frequency">Repayment Frequency (Collection Type) <span class="text-danger">*</span></label>
              <select id="repayment_frequency" name="repayment_frequency" class="form-select select2" required data-placeholder="Select Frequency">
                <option value="monthly" selected>Monthly (Monthly Date Collection)</option>
                <option value="weekly">Weekly (Weekly Day Collection)</option>
                <option value="daily">Daily (Everyday Collection)</option>
              </select>
            </div>
            ...
            <div class="col-md-4">
               <div class="d-flex justify-content-between align-items-center mb-2">
                 <label class="form-label mb-0" for="tenure">Tenure (Months) <span class="text-danger">*</span></label>
