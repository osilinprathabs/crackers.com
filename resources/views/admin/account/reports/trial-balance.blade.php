...
@section('title', $pageTitle ?? __('Trial Balance'))

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
    <h4 class="fw-bold mb-0"><i class="ri-scales-fill text-primary me-2"></i>{{ $pageTitle ?? __('Trial Balance') }}</h4>
  ...
  <div class="card shadow-sm border-0 rounded-4">
    <div class="card-body text-center p-5">
      ...
      <p class="text-muted mx-auto" style="max-width: 500px;">
        {{ __('The :title module is currently under active development. Data filters and tables will appear here once the backend integration is complete.', ['title' => $pageTitle ?? 'Trial Balance']) }}
      </p>
    </div>
  </div>
</div>
