  ...
  <div class="card shadow-sm border-0 rounded-4">
    <div class="card-body text-center p-5">
      ...
      <p class="text-muted mx-auto" style="max-width: 500px;">
        {{ __('The :title module is currently under active development. Data filters and tables will appear here once the backend integration is complete.', ['title' => $pageTitle ?? 'Cash Book']) }}
      </p>
    </div>
  </div>
</div>
