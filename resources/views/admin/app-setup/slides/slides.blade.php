          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center gap-1">
                <a href="{{ route('app-setup-slides-edit', ['id' => $slide]) }}" class="btn btn-sm btn-icon btn-text-secondary rounded-pill" title="Edit"><i class="icon-base ri ri-edit-box-line icon-22px text-primary"></i></a>
                <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-text-danger rounded-pill delete-slide" data-id="{{ $slide->getRouteKey() }}" data-title="{{ $slide->title }}" title="Delete"><i class="icon-base ri ri-delete-bin-7-line icon-22px text-danger"></i></a>
              </div>
            </td>
          </tr>
          @empty
